...
# Original: Clock period (8 ns) — 125 MHz
set MAIN_TCK 50.0
...
# Worst case aka when the clock is fastest, this clock is at half the frequency of the input clock into the processor
create_generated_clock -name CLK_RAND -source [get_ports ${MAIN_CLK_PIN}] -divide_by 2 [get_pins u_clkgen/o_clk]

# Constrain the clock at the clock-gate output, which drives all downstream logic.
create_generated_clock -name CLK_GATED -source [get_pins u_clkgen/o_clk] -divide_by 1 [get_pins core_clock_gate_i/clk_o]
