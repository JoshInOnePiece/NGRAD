...
create_pg_pin -dir input -name VSS4 -net VSS -geometry Metal7 633 0 653 25
create_pg_pin -dir input -name VDD4 -net VDD -geometry Metal7 603 0 623 25

#Top Side
create_pg_pin -dir input -name VSS5 -net VSS -geometry Metal7 120 747 140 772.73
create_pg_pin -dir input -name VDD5 -net VDD -geometry Metal7 150 747 170 772.73

create_pg_pin -dir input -name VSS6 -net VSS -geometry Metal7 633 747 653 772.73
create_pg_pin -dir input -name VDD6 -net VDD -geometry Metal7 603 747 623 772.73

# Left Side
create_pg_pin -dir input -name VDD1 -net VDD -geometry Metal7 0 633 25 653
create_pg_pin -dir input -name VSS1 -net VSS -geometry Metal7 0 603 25 623
...
#Right Side
create_pg_pin -dir input -name VDD7 -net VDD -geometry Metal7 746 633 771.4 653
create_pg_pin -dir input -name VSS7 -net VSS -geometry Metal7 746 603 771.4 623

create_pg_pin -dir input -name VDD8 -net VDD -geometry Metal7 746 120 771.4 140
create_pg_pin -dir input -name VSS8 -net VSS -geometry Metal7 746 150 771.4 170
