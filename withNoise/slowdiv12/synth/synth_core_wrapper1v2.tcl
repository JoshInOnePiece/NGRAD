...
report_timing > ../Synthesis/reports/noisyTop_report_timing1v2.rpt
report_power  > ../Synthesis/reports/noisyTop_report_power1v2.rpt
report_area   > ../Synthesis/reports/noisyTop_report_area1v2.rpt
report_qor    > ../Synthesis/reports/noisyTop_report_qor1v2.rpt

# Write the synthesized netlist and other output files
write_hdl > ../Synthesis/outputs/noisyTop_netlist1v2.v
write_sdc > ../Synthesis/outputs/noisyTop_sdc1v2.sdc
