...
report_gates > ../Synthesis/reports/noisyCore1v2_report_gates.rpt
report_area   > ../Synthesis/reports/noisyCore1v2_report_area.rpt

# Write the synthesized netlist and other output files
write_hdl > ../Synthesis/outputs/noisyCore1v2_netlist.v
